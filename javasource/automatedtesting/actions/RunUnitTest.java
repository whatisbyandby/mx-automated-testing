...
public class RunUnitTest extends CustomJavaAction<java.lang.Boolean>
{
	...
	private automatedtesting.proxies.UnitTest unitTest;
	...
	{
		this.unitTest = this.__unitTest == null ? null : automatedtesting.proxies.UnitTest.initialize(getContext(), __unitTest);
