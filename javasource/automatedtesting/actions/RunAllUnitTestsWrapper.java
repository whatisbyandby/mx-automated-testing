...
public class RunAllUnitTestsWrapper extends CustomJavaAction<java.lang.Boolean>
{
	...
	private automatedtesting.proxies.TestSuite testRun;
	...
	{
		this.testRun = this.__testRun == null ? null : automatedtesting.proxies.TestSuite.initialize(getContext(), __testRun);
